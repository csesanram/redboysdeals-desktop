...
public class TravelDeals {
	...
	public static void main(String[] args) throws Exception {
		...
		getTravel("http://api.epn.ebay.com/deals/v1/country/us/feed/json?campid=5337825386&categoryid=3252&customid=3001&count=40&offset=1&feedtype_id=2&toolid=100034&feedType=json");
	}

	public static void getTravel(String urlToRead) throws Exception {
		...
		System.out.println("Total Travel Deals Count:" +arr.length());
	...
	public static void generateOutput(String dealsStr) throws Exception {
        ...
        Template t = ve.getTemplate( "./src/com/redboysdeals/admin/travel_html.vm" );
        ...
        FileWriter fw = new FileWriter("./src/com/redboysdeals/admin/travel/traveldeals/travel.html");
        fw.write(sw.toString());
        fw.close();
        System.out.println( "travel.html file has been created!!!!.." );
	}
