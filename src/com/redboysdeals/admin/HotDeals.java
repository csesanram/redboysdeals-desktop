...
public class HotDeals {
	...
	public static void main(String[] args) throws Exception {
		...
		getClothing("http://api.epn.ebay.com/deals/v1/country/us/feed/json?campid=5337825386&categoryid=11450&customid=3001&count=40&offset=1&feedtype_id=2&toolid=100034&feedType=json");
	}

	public static void getClothing(String urlToRead) throws Exception {
		...
		System.out.println("Total Hot Deals Count:" +arr.length());
	...
	public static void generateOutput(String dealsStr) throws Exception {
        ...
        Template t = ve.getTemplate( "./src/com/redboysdeals/admin/hotdeals_html.vm" );
        ...
        FileWriter fw = new FileWriter("./src/com/redboysdeals/admin/hotdeals.html");
        fw.write(sw.toString());
        fw.close();
        System.out.println( "hotdeals.html file has been created!!!!.." );
	}
